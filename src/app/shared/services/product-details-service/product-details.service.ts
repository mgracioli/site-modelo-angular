...
export class ProductDetailsService {
  ...
  getDetails(id: string) : Observable<ProductDetails>{
    ...
    .pipe(
      //O método get() retorna um array de objetos em forma de stream; 'prods' é um array de objetos real, é a conversão dessa stream em objetos reais, o map vai pegar toda a stream de dados e converter cada objeto dela em um objeto real. Não é possível filtrar um observable, diretamente, precisa fazer o map
